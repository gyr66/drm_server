...
const communicationKeyId = config.axinom.communicationKeyId
const communicationKey = config.axinom.communicationKey
...
async function signToken(videoId) {
  ...
  let licenseToken = jwt.sign(
    envelope,
    Buffer.from(communicationKey, 'base64'),
    {
      algorithm: 'HS256',
      noTimestamp: true
    }
